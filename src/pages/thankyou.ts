...
export const renderThankYouPage = (): void => {
    const order = loadLastOrder();
    
    const orderCodeEl = document.querySelector<HTMLSpanElement>("#order-code");
    const orderDateEl = document.querySelector<HTMLSpanElement>("#order-date");
    const orderItemsEl = document.querySelector<HTMLDivElement>("#order-items");
    const orderTotalEl = document.querySelector<HTMLSpanElement>("#order-total");
    const whatsappBtn = document.querySelector<HTMLAnchorElement>("#btn-whatsapp");
    const continueBtn = document.querySelector<HTMLAnchorElement>("#btn-continue");
